 ...
 * 录音控件button
 */
public class RecordVoiceButton extends FloatingActionButton implements View.OnClickListener {

    private Dialog recordIndicator;
    private ImageView mVolumeIv, mIvPauseContinue, mIvComplete,mIvNoComplete;
    ...
    private void startRecordDialog() {
        ...
        mIvNoComplete= (ImageView) recordIndicator.findViewById(R.id.iv_nocomplete);
        ...
        mIvComplete.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                if (voiceManager != null) {
                    voiceManager.stopVoiceRecord(true);
                }
                recordIndicator.dismiss();
            }
        });
        //取消
        mIvNoComplete.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                if(voiceManager!=null){
                    voiceManager.stopVoiceRecord(false);
                }
                recordIndicator.dismiss();
            }
        });
    ...
    public void onClick(View view) {
        ...
        voiceManager.startVoiceRecord(Environment.getExternalStorageDirectory().getPath() + "/LcsdEdit/audio");
    }
