...
//    private static final String TAG = "JCameraView";
    ...
    public JCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        duration = a.getInteger(R.styleable.JCameraView_duration_max, 60 * 1000);       //没设置默认为10s
        a.recycle();
        initData();
        initView();
    }
...
//                    Log.i("CJT", "result = " + (result - firstTouchLength));
    ...
    public void setDrution(int drution){
        this.duration=drution;
        mCaptureLayout.setDuration(drution);
    }

    public void setMinDrution(int duration){
        mCaptureLayout.setMinDruration(duration);
    }
